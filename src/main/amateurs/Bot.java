...
import amateurs.executor.CommandExecutor;
import amateurs.executor.CommandExecutorFactory;
...
public class Bot implements LongPollingSingleThreadUpdateConsumer {
    ...
    private void processCommand(Message msg) {
        LOG.info("Processing command with message={} for chatId={}", msg, msg.getChatId());
    ...
    private void processCallbackQuery(CallbackQuery callbackQuery) {
        LOG.info("Processing callback query with query={} for chatId={}", callbackQuery, callbackQuery.getMessage().getChatId());
